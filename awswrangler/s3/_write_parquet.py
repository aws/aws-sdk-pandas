...
def to_parquet(  # pylint: disable=too-many-arguments,too-many-locals,too-many-branches,too-many-statements
    ...
    concurrent_partitioning: bool
        ...
        https://aws-sdk-pandas.readthedocs.io/en/3.0.0rc1/tutorials/022%20-%20Writing%20Partitions%20Concurrently.html
    mode: str, optional
        ``append`` (Default), ``overwrite``, ``overwrite_partitions``. Only takes effect if dataset=True.
        For details check the related tutorial:
        https://aws-sdk-pandas.readthedocs.io/en/3.0.0rc1/tutorials/004%20-%20Parquet%20Datasets.html
    ...
    schema_evolution : bool
        ...
        Related tutorial:
        https://aws-sdk-pandas.readthedocs.io/en/3.0.0rc1/tutorials/014%20-%20Schema%20Evolution.html
