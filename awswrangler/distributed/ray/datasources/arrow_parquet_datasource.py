...
import logging
from typing import Any, Callable, Dict, Iterator, Literal, List, Optional, Union
...
class _ArrowParquetDatasourceReader(Reader):  # pylint: disable=too-many-instance-attributes
    def __init__(
        ...
        **reader_args: Any,
        ...
        if partition_filter is not None:
            ...
            if filtered_paths:
                _logger.info(f"Filtered out the following paths: {filtered_paths}")
    ...
    def _estimate_files_encoding_ratio(self) -> float:
        ...
        sample_fragment = ray_remote(scheduling_strategy=self._local_scheduling or "SPREAD")(_sample_fragment)
        futures = []
