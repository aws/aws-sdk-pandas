...
def delete_all_dashboards(
    account_id: Optional[str] = None, filter: Optional[str] = None, boto3_session: Optional[boto3.Session] = None
) -> None:
    ...
    account_id : str, optional
        If None, the account ID will be inferred from your boto3 session.
    filter : str, optional
        Regex filter that will delete all dashboards with a match in their ``Name``
    boto3_session : boto3.Session(), optional
        Boto3 Session. The default boto3 session will be used if boto3_session receive None.
    ...
    for dashboard in list_dashboards(account_id=account_id, boto3_session=session):
        if filter:
            if not re.search(f"^{filter}$", dashboard["Name"]):
                continue
...
def delete_all_datasets(
    ...
    account_id : str, optional
        If None, the account ID will be inferred from your boto3 session.
    filter : str, optional
        Regex filter that will delete all datasets with a match in their ``Name``
    boto3_session : boto3.Session(), optional
        Boto3 Session. The default boto3 session will be used if boto3_session receive None.
    ...
    for dataset in list_datasets(account_id=account_id, boto3_session=session):
        if filter:
            if not re.search(f"^{filter}$", dataset["Name"]):
                continue
...
def delete_all_data_sources(
    ...
    account_id : str, optional
        If None, the account ID will be inferred from your boto3 session.
    filter : str, optional
        Regex filter that will delete all data sources with a match in their ``Name``
    boto3_session : boto3.Session(), optional
        Boto3 Session. The default boto3 session will be used if boto3_session receive None.
    ...
    for data_source in list_data_sources(account_id=account_id, boto3_session=session):
        if filter:
            if not re.search(f"^{filter}$", data_source["Name"]):
                continue
...
def delete_all_templates(
    ...
    account_id : str, optional
        If None, the account ID will be inferred from your boto3 session.
    filter : str, optional
        Regex filter that will delete all templates with a match in their ``Name``
    boto3_session : boto3.Session(), optional
        Boto3 Session. The default boto3 session will be used if boto3_session receive None.
    ...
    for template in list_templates(account_id=account_id, boto3_session=session):
        if filter:
            if not re.search(f"^{filter}$", template["Name"]):
                continue
