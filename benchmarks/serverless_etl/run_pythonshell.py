...
def run_job(name, workload, bucket):
    ...
    print(f"Starting pythonshell job for {key}")
    ...
    print(f"Finished pythonshell job for {key}")
...
def main():
    ...
    name = configs.get("pythonshell-name")
    ...
    if not os.path.exists("metrics"):
        os.makedirs("metrics")
    json.dump(metrics, open("metrics/pythonshell.json", "w"))
