...
def test_basics(path, glue_database, glue_table, workgroup0, workgroup1):
    ...
    wr.config.timestream_write_endpoint_url = f"https://ingest-cell2.timestream.{region}.amazonaws.com"
    wr.config.timestream_query_endpoint_url = f"https://query-cell2.timestream.{region}.amazonaws.com"
    ...
    os.environ["WR_TIMESTREAM_WRITE_ENDPOINT_URL"] = f"https://ingest-cell2.timestream.{region}.amazonaws.com"
    os.environ["WR_TIMESTREAM_QUERY_ENDPOINT_URL"] = f"https://query-cell2.timestream.{region}.amazonaws.com"
    wr.config.reset()
    _urls_test(glue_database)
