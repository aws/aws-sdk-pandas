...
* Value: ``cython==0.29.21,pg8000==1.21.0,pyarrow==2,pandas==1.3.0,awswrangler==3.0.0a1``
...
For example: ``s3://aws-data-wrangler-public-artifacts/releases/3.0.0a1/awswrangler-layer-3.0.0a1-py3.8.zip``
...
.. note:: Make sure to freeze the library version in the bootstrap for production
          environments (e.g. awswrangler==3.0.0a1)
