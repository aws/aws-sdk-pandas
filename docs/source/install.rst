...
.. note:: Glue Python Shell runs on Python3.6, for which support was dropped in version 2.15.1 of Wrangler. Please use version 2.14.0 of the library or below.
